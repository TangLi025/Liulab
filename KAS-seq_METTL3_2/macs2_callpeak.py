GROUP=["METTL3_2","METTL14","YTHDC1","METTL3_1","METTL3_3"]
SAMPLE=["CTRL","KO"]
...
rule all:
  input:
    ...
    expand("{group}/06_macs2/broad/KAS-seq_{group}_{sample}_{rep}_nomodel_peaks.broadPeak",group=GROUP,sample=SAMPLE,rep=REP),
...
rule macs2_callpeak_broad_nomodel:
  input:
    ...
    "{group}/05_bedtools/bed_extend/KAS-seq_{group}_{sample}_input_{rep}_ext.bed"
  output:
    "{group}/06_macs2/broad/KAS-seq_{group}_{sample}_{rep}_nomodel_peaks.broadPeak",
    "{group}/06_macs2/broad/KAS-seq_{group}_{sample}_{rep}_nomodel_peaks.xls"
  log:
    "{group}/logs/macs2_callpeak/broad/KAS-seq_{group}_{sample}_{rep}_nomodel.log"
  params:
    out_name="KAS-seq_{group}_{sample}_{rep}_nomodel",
    out_dir="{group}/06_macs2/broad"
  shell:
    "/disk1/home/user_09/anaconda3/envs/m6A/bin/macs2 callpeak \
      --nomodel \
