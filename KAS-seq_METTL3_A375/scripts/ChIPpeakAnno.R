...
CTRL_bed1 <- paste0("~/KAS-METTL/",GROUP,"/06_macs2/",MODE,"/",GROUP,"_Control_rep1_peaks.",TYPE)
CTRL_bed2 <- paste0("~/KAS-METTL/",GROUP,"/06_macs2/",MODE,"/",GROUP,"_Control_rep2_peaks.",TYPE)

KO_bed1 <- paste0("~/KAS-METTL/",GROUP,"/06_macs2/",MODE,"/",GROUP,"_KDMETTL3_rep1_peaks.",TYPE)
KO_bed2 <- paste0("~/KAS-METTL/",GROUP,"/06_macs2/",MODE,"/",GROUP,"_KDMETTL3_rep2_peaks.",TYPE)
