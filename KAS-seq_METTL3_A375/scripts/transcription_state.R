...
mean_total <- 55262849*4/2827437033

class1_gene <- density_mean[density_mean[,2]>=mean_total*20 & density_mean[,3]>=mean_total*10,1]
class2_gene <- density_mean[density_mean[,2]>=mean_total*20 & density_mean[,3]<mean_total*10,1]
class3_gene <- density_mean[density_mean[,2]<mean_total*20 & density_mean[,3]>=mean_total*10,1]
class4_gene <- density_mean[density_mean[,2]<mean_total*20 & density_mean[,3]<mean_total*10,1]
