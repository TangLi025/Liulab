...
rule all:
  input:
    expand("05_bedtools/HEK_{treatment}_{rep}_ext.bw",treatment=TREATMENT,rep=REP),
...
rule bed_extend:
  input:
    ...
    CHROM_SIZE
  output:
    "05_bedtools/HEK_{treatment}_{rep}_ext.bed"
  log:
    "logs/bed_extend/HEK_{treatment}_{rep}.log"
  script:
    "script/bed_extend.R"
...
rule bed2bedGraph:
  input:
    ...
    GENOME_INDEX
  output:
    "05_bedtools/HEK_{treatment}_{rep}_ext.bg"
  log:
...
rule bedGraphToBigWig:
  input:
    ...
    GENOME_INDEX
  output:
    "05_bedtools/HEK_{treatment}_{rep}_ext.bw"
  log:
...
rule macs2_callpeak:
  input:
    "05_bedtools/HEK_IP_{rep}_ext.bed",
    "05_bedtools/HEK_input_{rep}_ext.bed"
  output:
