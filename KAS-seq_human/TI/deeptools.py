...
rule all:
  input:
    ...
    "07_deeptools/plotPCA/DMSO_input.png",
    "07_deeptools/multiBigwigSummary/DMSO_input.npz",
    "07_deeptools/multiBigwigSummary/TI_compare.npz",
    "07_deeptools/plotPCA/TI_compare.png"
    
rule plotPCA:
  input:
    "07_deeptools/multiBigwigSummary/{group}_compare.npz"
  output:
    "07_deeptools/plotPCA/{group}_compare.png"
  log:
    "logs/plotPCA/{group}_input.log"
  params:
    genes="genes"
  threads: 1
  shell:
...
rule multiBigwigSummary:
  input:
    expand("07_deeptools/bamCoverage/{sample}_{treatment}_{rep}.bw",sample=SAMPLE,treatment=TREATMENT,rep=REP)
  output:
    npz="07_deeptools/multiBigwigSummary/{group}_compare.npz"
  params:
    blacklist=BLACKLIST
  log:
    "logs/multiBigwigSummary/{group}_compare.log"
  threads: 10
  shell:
