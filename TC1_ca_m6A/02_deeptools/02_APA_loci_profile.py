...
rule all:
  input:
    "07_deeptools/plotProfile/coverage_p5p10.pdf",
    "07_deeptools/plotProfile/compare_p5p10.pdf"
...
rule computeMatrix_coverage:
  ...
  output:
    mat="07_deeptools/computeMatrix/coverage_p5p10.mat.gz",
    tab="07_deeptools/computeMatrix/coverage_p5p10.tab",
    bed="07_deeptools/computeMatrix/coverage_p5p10.bed"
  log:
    "logs/computeMatrix_distribution/coverage_p5p10.log"
  params:
    short="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_loci_p5p10_short.bed",
    long="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_loci_p5p10_long.bed",
    nc="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_loci_p5p10_nc.bed",
  threads: 30
  shell:
...
rule plotProfile_coverage:
  input:
    mat="07_deeptools/computeMatrix/coverage_p5p10.mat.gz"
  output:
    pdf="07_deeptools/plotProfile/coverage_p5p10.pdf"
  log:
    "logs/plotProfile/coverage_p5p10.log"
  params:
    genes="genes"
  threads: 1
  shell:
...
rule computeMatrix_compare:
  ...
  output:
    mat="07_deeptools/computeMatrix/compare_p5p10.mat.gz",
    tab="07_deeptools/computeMatrix/compare_p5p10.tab",
    bed="07_deeptools/computeMatrix/compare_p5p10.bed"
  log:
    "logs/computeMatrix_distribution/compare_p5p10.log"
  params:
    short="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_loci_p5p10_short.bed",
    long="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_loci_p5p10_long.bed",
    nc="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_loci_p5p10_nc.bed",
...
rule plotProfile_compare:
  input:
    mat="07_deeptools/computeMatrix/compare_p5p10.mat.gz"
  output:
    pdf="07_deeptools/plotProfile/compare_p5p10.pdf"
  log:
    "logs/plotProfile/compare_p5p10.log"
  params:
    genes="genes"
  threads: 1
  shell:
