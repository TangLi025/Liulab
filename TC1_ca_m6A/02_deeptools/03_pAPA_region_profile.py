...
rule all:
  input:
    "07_deeptools/plotProfile/coverage_p0p10_pAPA.pdf",
    "07_deeptools/plotProfile/compare_p0p10_pAPA.pdf"
...
rule computeMatrix_coverage:
  ...
  output:
    mat="07_deeptools/computeMatrix/coverage_p0p10_pAPA.mat.gz",
    tab="07_deeptools/computeMatrix/coverage_p0p10_pAPA.tab",
    bed="07_deeptools/computeMatrix/coverage_p0p10_pAPA.bed"
  log:
    "logs/computeMatrix_distribution/coverage_p0p10_pAPA.log"
  params:
    short="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_region_p0p10_short.bed",
    long="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_region_p0p10_long.bed",
    nc="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_region_p0p10_nc.bed",
  threads: 30
  shell:
...
rule plotProfile_coverage:
  input:
    mat="07_deeptools/computeMatrix/coverage_p0p10_pAPA.mat.gz"
  output:
    pdf="07_deeptools/plotProfile/coverage_p0p10_pAPA.pdf"
  log:
    "logs/plotProfile/coverage_p0p10_pAPA.log"
  params:
    genes="genes"
  threads: 1
  shell:
...
rule computeMatrix_compare:
  ...
  output:
    mat="07_deeptools/computeMatrix/compare_p0p10_pAPA.mat.gz",
    tab="07_deeptools/computeMatrix/compare_p0p10_pAPA.tab",
    bed="07_deeptools/computeMatrix/compare_p0p10_pAPA.bed"
  log:
    "logs/computeMatrix_distribution/compare_p0p10_pAPA.log"
  params:
    short="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_region_p0p10_short.bed",
    long="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_region_p0p10_long.bed",
    nc="/disk/user_09/Data/03_TC1_caRNA/12_dapars/APA_region_p0p10_nc.bed",
...
rule plotProfile_compare:
  input:
    mat="07_deeptools/computeMatrix/compare_p0p10_pAPA.mat.gz"
  output:
    pdf="07_deeptools/plotProfile/compare_p0p10_pAPA.pdf"
  log:
    "logs/plotProfile/compare_p0p10_pAPA.log"
  params:
    genes="genes"
  threads: 1
  shell:
