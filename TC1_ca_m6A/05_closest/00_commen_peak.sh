#!/bin/sh
cd /disk/user_09/Data/user_08_TC1/05_bam_change_index_hisat2/01_bam_sorted
...
cat p0_rep1_rep2_common_peaks.bed p5_rep1_rep2_common_peaks.bed | sort -k1,1 -k2,2n | bedtools merge -s -c 6 -o distinct | awk -F "\t" -v OFS="\t" '{print $1,$2,$3,"peak"NR,".",$4}'> ../02_merge_peaks/p0p5.merge.bed
cat p0_rep1_rep2_common_peaks.bed p10_rep1_rep2_common_peaks.bed | sort -k1,1 -k2,2n | bedtools merge -s -c 6 -o distinct | awk -F "\t" -v OFS="\t" '{print $1,$2,$3,"peak"NR,".",$4}'> ../02_merge_peaks/p0p10.merge.bed
cat rp2_rep1_rep2_common_peaks.bed p5_rep1_rep2_common_peaks.bed | sort -k1,1 -k2,2n | bedtools merge -s -c 6 -o distinct | awk -F "\t" -v OFS="\t" '{print $1,$2,$3,"peak"NR,".",$4}'> ../02_merge_peaks/rp2p5.merge.bed
cat rp2_rep1_rep2_common_peaks.bed p10_rep1_rep2_common_peaks.bed | sort -k1,1 -k2,2n | bedtools merge -s -c 6 -o distinct | awk -F "\t" -v OFS="\t" '{print $1,$2,$3,"peak"NR,".",$4}'> ../02_merge_peaks/rp2p10.merge.bed