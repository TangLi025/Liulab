...
setwd("/disk/user_09/Data/03_TC1_caRNA/12_dapars/dapars2_caRNA_new/")
library(ggplot2)
library(tidyverse)

dapars2_caRNA_mRNA <- as_tibble(read.table("DaPars2_caRNA_result.txt",header = TRUE))

colnames(dapars2_caRNA_mRNA) <- c("Gene","fit_value",
                                  "Predicted_Proximal_APA","Loci",
                                  "caRNA_p0_rep1_PDUI","caRNA_p0_rep2_PDUI",
                                  "caRNA_p5_rep1_PDUI","caRNA_p5_rep2_PDUI",
                                  "caRNA_p10_rep1_PDUI","caRNA_p10_rep2_PDUI",
                                  "caRNA_rp2_rep1_PDUI","caRNA_rp2_rep2_PDUI")

#write.table(dapars2_caRNA_mRNA,"DaPars2_caRNA_rowname_modified.txt",quote = FALSE,sep="\t",row.names = FALSE)
...
#write.table(dapars2_mean_omitNA,"DaPars2_caRNA_mean_omitNA.txt",quote = FALSE,sep="\t",row.names = FALSE)
