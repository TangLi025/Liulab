...
dapars2_caRNA_mRNA <- as_tibble(read.table("DaPars2_caRNA_mRNA_all.txt",header = TRUE))
...
#write.table(dapars2_caRNA_mRNA,"DaPars2_caRNA_mRNA_rowname_modified.txt",quote = FALSE,sep="\t",row.names = FALSE)
