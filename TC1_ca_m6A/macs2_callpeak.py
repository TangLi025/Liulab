...
rule bam_separate:
  ...
  shell:
    """
  	/disk1/home/user_09/anaconda3/envs/LinLong/bin/samtools view -@ {threads} -q 20 -b -f 83 {input[0]} 1> {output[0]}
  	/disk1/home/user_09/anaconda3/envs/LinLong/bin/samtools view -@ {threads} -q 20 -b -f 163 {input[0]} 1> {output[1]}
  	/disk1/home/user_09/anaconda3/envs/LinLong/bin/samtools view -@ {threads} -q 20 -b -f 99 {input[0]} 1> {output[2]}
  	/disk1/home/user_09/anaconda3/envs/LinLong/bin/samtools view -@ {threads} -q 20 -b -f 147 {input[0]} 1> {output[3]}
