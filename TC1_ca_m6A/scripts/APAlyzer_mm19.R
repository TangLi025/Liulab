...
flsall = c("/disk1/home/user_09/TC1_m6A/mm19/04_bam_raw/TC1_P0_input_rep1.bam","/disk1/home/user_09/TC1_m6A/mm19/04_bam_raw/TC1_P0_input_rep2.bam","/disk1/home/user_09/TC1_m6A/mm19/04_bam_raw/TC1_P10_input_rep1.bam","/disk1/home/user_09/TC1_m6A/mm19/04_bam_raw/TC1_P10_input_rep2.bam")
names(flsall) <- c("P0_rep1","P0_rep2","P10_rep1","P10_rep2")
flsall

library(repmis)

GTFfile <- "/disk1/home/user_09/reference/annotation/mm19/gencode.vM28.annotation.protein_coding.chr.gtf"
...
UTRdb=PASREF$UTRdbraw
dfIPA=PASREF$dfIPA
dfLE=PASREF$dfLE  

dfLE$LEstart <- as.numeric(dfLE$LEstart)
dfLE$TES <- as.numeric(dfLE$TES)

## Extract 3 prime most alignment of a paired-end 
## bam file and saved into a new bam file
for (i in 2:4){
  Bamfile <- flsall[i]
  Outdir='/disk1/home/user_09/TC1_m6A/mm19/04_bam_raw_3most/'  
...
flsall_3most <- c('/disk1/home/user_09/TC1_m6A/mm19/04_bam_raw_3most/TC1_P0_input_rep1.3most.bam','/disk1/home/user_09/TC1_m6A/mm19/04_bam_raw_3most/TC1_P0_input_rep2.3most.bam','/disk1/home/user_09/TC1_m6A/mm19/04_bam_raw_3most/TC1_P10_input_rep1.3most.bam','/disk1/home/user_09/TC1_m6A/mm19/04_bam_raw_3most/TC1_P10_input_rep2.3most.bam')
names(flsall_3most) <- c("P0_rep1","P0_rep2","P10_rep1","P10_rep2")

ThreemostBamfile="test.3most.bam"
IPA_OUTraw=PASEXP_IPA(dfIPAraw, dfLE, flsall_3most, Strandtype="NONE", SeqType="ThreeMostPairEnd",nts=50,minMQS = 10)

DFUTRraw=PASEXP_3UTR(UTRdbraw, flsall, Strandtype="NONE")

IPA_OUTraw=PASEXP_IPA(dfIPA, dfLE, flsall, Strandtype="NONE", nts=40,minMQS = 10,SeqType = "ThreeMostPairEnd")
head(IPA_OUTraw,2)
...
APAVolcano(test_3UTRmuti, PAS='3UTR', Pcol = "pvalue", top=5, plot_title='3UTR APA',y_cutoff = 0.05,alpha = 0.3)
